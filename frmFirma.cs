    ...
    public partial class frmFirma : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Directory.Exists(ruta)) //Si no existe la crea
                {
                    Directory.CreateDirectory(ruta);
                }
                string archivo = $"{DateTime.Now.ToString("yyyy-MM-dd hhmmss")}.png"; //El nombre del archivo va a ser la fecha y hora
